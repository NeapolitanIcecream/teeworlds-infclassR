...
void CMapConverter::Finalize()
{
	...
	int SpyImageID = AddExternalImage("../skins/warpaint", 256, 128);
	int ArchitectImageID = AddExternalImage("../skins/whis", 256, 128);
					...
					else
					{
						...
						switch(i)
						{
							...
							case MENUCLASS_LOOPER:
								...
								break;
							case MENUCLASS_SPY:
								AddTeeLayer("Spy", SpyImageID, Pos, 64.0f, m_NumEnvs-1);
								break;
							case MENUCLASS_ARCHITECT:
								AddTeeLayer("Architect", ArchitectImageID, Pos, 64.0f, m_NumEnvs-1);
								break;
							case MENUCLASS_MEDIC:
