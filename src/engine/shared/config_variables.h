...
MACRO_CONFIG_INT(SvPort, sv_port, 19359, 0, 0, CFGFLAG_SERVER, "Port to use for the server")
...
MACRO_CONFIG_INT(InfNinjaJump, inf_ninja_jump, 3, 0, 1024, CFGFLAG_SERVER, "Maximum number of katana attacks")
